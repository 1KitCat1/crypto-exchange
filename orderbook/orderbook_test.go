...
func TestLimit(t *testing.T) {
	...
	buyOrderA := NewOrder(true, 5, MarketETH) // true - buy|bid, false - sell|ask
	buyOrderB := NewOrder(true, 7, MarketETH)
	buyOrderC := NewOrder(true, 11, MarketETH)
...
func TestPlaceLimitOrder(t *testing.T) {
	...
	orderbook.PlaceLimitOrder(10_000, NewOrder(ASK, 10, MarketETH))
	assert(t, len(orderbook.asks), 1)
	orderbook.PlaceLimitOrder(11_000, NewOrder(ASK, 15, MarketETH))
	assert(t, len(orderbook.asks), 2)

	orderbook.PlaceLimitOrder(9_000, NewOrder(BID, 8, MarketETH))
...
func TestPlaceMarketOrder(t *testing.T) {
	...
	sellOrder := NewOrder(ASK, 10, MarketETH)
	orderbook.PlaceLimitOrder(100, sellOrder)

	buyOrder := NewOrder(BID, 5, MarketETH)
...
func TestPlaceMarketOrderMultipleMatches(t *testing.T) {
	...
	orderbook.PlaceLimitOrder(9_000, NewOrder(BID, 12, MarketETH))
	orderbook.PlaceLimitOrder(10_000, NewOrder(BID, 7, MarketETH))
	orderbook.PlaceLimitOrder(9_000, NewOrder(BID, 8, MarketETH))

	assert(t, orderbook.BidsTotalVolume(), 7+8+12.0)

	sellOrder := NewOrder(ASK, 20, MarketETH)
...
func TestPlaceMarketOrderMultipleOrdersOnLimit(t *testing.T) {
	...
	orderbook.PlaceLimitOrder(5_000, NewOrder(BID, 1, MarketETH))
	orderbook.PlaceLimitOrder(5_000, NewOrder(BID, 10, MarketETH))
	orderbook.PlaceLimitOrder(9_000, NewOrder(BID, 8, MarketETH))
	orderbook.PlaceLimitOrder(10_000, NewOrder(BID, 5, MarketETH))
...
func TestCancelOrder(t *testing.T) {
	...
	order := NewOrder(BID, 10, MarketETH)
	orderbook.PlaceLimitOrder(10_000, NewOrder(BID, 15, MarketETH))
